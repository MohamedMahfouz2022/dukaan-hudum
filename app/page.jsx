          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                size="lg"
                asChild
                className="border-black text-white hover:text-black hover:bg-white"
              >
                <Link href="/shop">
                  تسوق المجموعة
                </Link>
              ...
              <Button
                ...
                size="lg"
                asChild
                className="border-white text-black hover:text-white hover:bg-black"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground uppercase mt-1">تشفير عبر سترايب</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
        ...
        <div className="luxury-container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-6xl font-serif italic mb-10 tracking-tight leading-tight">
              "نصوغ مستقبل الأناقة الرجالية من خلال التراث والابتكار."
            </h2>
